  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          title="Strengths"
          icon={<AceternityIcon order="Strengths" />}
          des="Quick learner with strong problem-solving skills, passionate about building impactful AI-driven solutions, and highly adaptive to new technologies and challenges."
        >
          <CanvasRevealEffect
            animationSpeed={3}
